...
try:
    repeat = int(input("Please input the number of BMI you would like to find: "))
    print("Enter your height in cm follow by your weight in kg: \n")
    for i in range(repeat):
        userInput = input()
        BMI.append(getBMI(float(userInput.split()[0]), float(userInput.split()[1])))
    print("Answer: \n {}".format(BMI))
